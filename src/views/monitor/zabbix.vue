...
<script>
  import { getZabbixStatus, getZabbixProduct } from '@/api/monitor/zabbix'

  export default {
    data() {
      return {
        total_host: 0, // 服务器总数量
        zabbix_total_host: 0, // monitor 中 host 总数
        zabbix_monitor_host: 0, // monitor 中正常监控的host数
        zabbix_not_monitor_host: 0, // zabbix中，没有监控的主机数
        zabbix_monitor_exception_host: 0, // zabbix中，监控异常的主机数： monitor agent 异常
        zabbixProductData: [],
        loading: false
      }
    },
